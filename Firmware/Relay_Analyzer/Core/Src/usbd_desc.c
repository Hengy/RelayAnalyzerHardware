...
#define USBD_PID                      0x002A  /* Replace '0xaaaa' with your device product ID */
#define USBD_LANGID_STRING            0x0409  /* Replace '0xbbb' with your device language ID */
#define USBD_MANUFACTURER_STRING      "Kevin&Matt" /* Add your manufacturer string */
#define USBD_PRODUCT_FS_STRING        "RelayAnalyzer" /* Add your product Full Speed string */
#define USBD_CONFIGURATION_FS_STRING  "RelayAnalyzer Config" /* Add your configuration Full Speed string */
#define USBD_INTERFACE_FS_STRING      "RelayAnalyzer Interface" /* Add your Interface Full Speed string */
